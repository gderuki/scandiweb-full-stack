...
import AttributeSet from 'components/molecules/AttributeSet';
  ...
  constructor(props) {
    ...
    this.state = {
      productDetails:
      {
        ...
        attributes: {
          colors: [{ hex: '#FF5733' }, { hex: '#00FF00' }, { hex: '#FFFF00' }],
          sizes: ['S', 'M', 'L', 'XL'],
    ...
    const sanitizeAttributes = (attributes) => {
      ...
      Object.keys(attributes).forEach((key) => {
        if (allowedAttributes.includes(key)) {
          safeAttributes[key] = sanitizeContent(attributes[key]);
        }
      });
        ...
        <div className='page-container'>
          ...
          <div className='second-line-wrapper'>
            ...
            <div className='product-info'>
              ...
              <AttributeSet attributes={productDetails.attributes} />
